...
$eeppCobro = ModeloFacturacionEEPP::mdlMostrarRegistrosND($idND);
...
<table class="table-bordered table-striped table-hover dt-responsive" id="tablaND" width="100%"> 
  ...
  <tr>     
    ...
    <td ><div align="right"><?= '$ '.number_format($valor,0,'','.')?></div></td> 
     <td align="center" nowrap=""><button class="btn btn-danger btn-xm" onclick="quitarRegistroND('<?=$id?>')"></button>
