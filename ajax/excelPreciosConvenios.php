...
$nombreDelDocumento = "Convenios Precios.xlsx";
$hojaDeEquipos = $documento->getActiveSheet();
$hojaDeEquipos->setTitle("Hoja 1");

$encabezado = ["ID","CATEGORIA", "MARCA", "EQUIPO", "MODELO", "PRECIO LISTA","PRECIO CONVENIO"];
...
$preciosEquipos = ModeloCargaMasivaPrecios::mdlConsultaListaEquipos();
            $blanco = "";
