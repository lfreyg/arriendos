		...
		$id_pedido = $this->id_pedido;	
		 ...
		 foreach ($productos as $key => $value){
           ...
           if($porDespachar == 0){
		  	...
		  	$botones =  "<div class='btn-group'><button ".$disable." class='btn btn-primary agregarEquipoPedido' idCategoria='".$value["idCategoria"]."', idPedidoDetalle='".$idPedidoDetalle."'>Agregar</button></div>"; 
